...
export const DEFAULT_ACTIVITIES: ActivityPreview[] = [
  {
    ...
    firstTipImageUrl:
      "https://images.unsplash.com/photo-1622758423399-f7edeb5f5c88?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ratingCount: 15,
    ratingAverage: 4.5,
    tipsNumber: 2,
  },
